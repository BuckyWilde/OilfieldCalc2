...
{
    public class LongPressBehavior : Behavior<Expander>
    {
        //TODO: wire a summary for the class or get rid of it if unused
        ...
        protected override void OnAttachedTo(Expander button)
        {
            base.OnAttachedTo(button);
            this.BindingContext = button.BindingContext;
            button.Tapped += Button_Pressed;
            button.Tapped += Button_Released;
        }

        protected override void OnDetachingFrom(Expander button)
        {
